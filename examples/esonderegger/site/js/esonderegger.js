...
function enterFullScreen(containerSelection, vidSelection, svgSelection, displayWidth) {
  ...
  vidSelection[0][0].setAttribute("width", screen.width);
  vidSelection[0][0].setAttribute("height", screen.height);
  containerSelection.style("height", null)
  svgSelection.style("margin-top", screen.height - 40 + "px");
  svgSelection.style("margin-left", (screen.width / 2) - (displayWidth / 2) + "px");
}
